...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(13)(proto, TO_PRIMITIVE, __webpack_require__(259));
...
exports.warning = exports.serif = exports.sansSerif = undefined;

var _FCSansSerif = __webpack_require__(391);

var _FCSansSerif2 = _interopRequireDefault(_FCSansSerif);

var _FCSerif = __webpack_require__(392);

var _FCSerif2 = _interopRequireDefault(_FCSerif);

var _warningTriangle = __webpack_require__(393);

var _warningTriangle2 = _interopRequireDefault(_warningTriangle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var parser = new DOMParser();

var sansSerif = exports.sansSerif = function sansSerif() {
...
var serif = exports.serif = function serif() {
...
function init() {
  ...
  try {
    ...
    gain.gain.value = 0;
    smoothFreq = (0, _smoothTo2.default)(source.frequency, ctx);
    source.start();
  } catch (e) {
    console.log(e);
  }
...
function playTone() {
  var baseFreq = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 3000;
  var timeout = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 200;

  init();

  try {
    var multiplier = _.sample([1, 1.25, 1.3333333, 2, 1.5, 1.125]);
...
var c = __webpack_require__(415);
var dynamicInterval = __webpack_require__(611);
var atLeast1 = _.atLeast(1);

var changeColors = function changeColors(elem, baseColor) {
  var properties = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

  var primaryColor = baseColor;
  var secondaryColor = c.polarize(primaryColor);
  ...
  return function (input) {
    ...
    if (!window.IMPORTANT.pause) {
      ...
      properties.primary.forEach(function (p) {
        return $(elem, p, primaryColor);
      });
      properties.secondary.forEach(function (s) {
        return $(elem, s, secondaryColor);
      });
    }
  };
};
...
var maxChange = 10;
var baseDistance = 700;
var baseTime = 15;

var defaultOptions = { factor: 1.5, primary: undefined, secondary: undefined };

function createSpeedSetter(elem, baseColor) {
  var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : defaultOptions,
      primary = _ref.primary,
      secondary = _ref.secondary,
      _ref$factor = _ref.factor,
      factor = _ref$factor === undefined ? 1.5 : _ref$factor;

  var _dynamicInterval = dynamicInterval(changeColors(elem, baseColor, { primary: primary, secondary: secondary })),
      set = _dynamicInterval.set,
      clear = _dynamicInterval.clear;

  return function (rawDistance) {
    var distance = atLeast1(rawDistance);
    var distProportion = distance / baseDistance;

    var time = _.atLeast(baseTime)(_.round(baseTime * distProportion * factor));

    var colorChange = _.round(atLeast1(-maxChange * (1 - Math.pow(distProportion, -0.1))));
...
function updateColorSpeedDistance(elem, baseColor, baseSpeed) {
  var elemCenter = $.center(elem);
  var setSpeed = createSpeedSetter(elem, baseColor);
  setSpeed(baseSpeed.distance, baseSpeed.time);

  return {
    updateColorSpeed: function updateColorSpeed(_ref2) {
      var coords = _ref2.coords;

      var distance = _.distance(coords, elemCenter);
      setSpeed(distance);
    },
...
module.exports = { updateColorSpeedDistance: updateColorSpeedDistance, changeColors: changeColors };
...
var _getRef = __webpack_require__(389);

var _playTone = __webpack_require__(414);

var _playTone2 = _interopRequireDefault(_playTone);

var _2 = __webpack_require__(59);
...
var _colors = __webpack_require__(415);

var _symbol = __webpack_require__(390);

var _signupModal = __webpack_require__(612);
...
var _require = __webpack_require__(602),
    changeColors = _require.changeColors;
...
var $menuStart = _$2.default.id('menuStart');
var $faqCTA = _$2.default.id('faqCTA');
...
$content.appendChild((0, _signupModal.modal)($callToAction, $menuStart, $faqCTA, $popup, $popup2));
...
var colorSwitchers = _$2.default.cls('color-speed-distance');
var colorMouses = _$2.default.cls('color-distance');
var shadowChanges = _$2.default.cls('shadow-change');
var colorTimeChangers = _$2.default.cls('color-time-change');

var baseSpeed = { distance: 600, time: 1 };

var baseShadowRadius = 20;
var orientAdjust = 10;

var updateBoxShadow = function updateBoxShadow(box) {
  return function (_ref) {
    var coords = _ref.coords;

    var center = _$2.default.center(box);
    var distance = _3.default.distance(coords, center);
    var degree = _3.default.degreeAroundCenter(coords, center);

    var shadowColor = c.applyToHex('#500', {
      h: _3.default.round(degree),
      v: _3.default.atMost(0.5)(distance / 800)
    });

    var shadowRadius = baseShadowRadius * (distance / 350) + baseShadowRadius;
    var x = _3.default.round(shadowRadius * _3.default.sin(degree));
    var y = _3.default.round(shadowRadius * _3.default.cos(degree));

    var boxShadowStyle = y + 'px ' + x + 'px ' + baseShadowRadius + 'px ' + shadowColor;

    (0, _$2.default)(box, 'box-shadow', boxShadowStyle);
  };
};
...
var clearOrients = shadowChanges.map(function (box) {
  var update = updateBoxShadow(box);

  return _$2.default.onOrient(function (_ref2) {
    var beta = _ref2.beta,
        gamma = _ref2.gamma,
...
_$2.default.onMouseMove()(function () {
  return clearOrients.forEach(_3.default.runFn);
});

var updaters = colorSwitchers.map(function (box) {
  return updateColorSpeedDistance(box, c.applyToHex('#ff0000', { h: _3.default.random(360) }), baseSpeed, {
...
_$2.default.onMouseMove()(function (event) {
  updaters.map(function (updater) {
    return updater.updateColorSpeed(event);
  });
});
...
_$2.default.onMouseMove()(function (event) {
  return shadowChanges.map(function (box) {
    return updateBoxShadow(box)(event);
  });
});
...
colorMouses.forEach(function (elem) {
  // random color when there is no initial mouse
  changeColors(elem, baseButtonColor)(_3.default.random(360));

  var isHovering = void 0;

  _$2.default.onHover(elem)(function (enterEvent) {
  ...
  _$2.default.onMouseMove()(function (event) {
    var dist = _$2.default.distanceFromCenter(elem, event);
    var hue = _3.default.round(dist / 3);
    var adj = isHovering ? 180 : 0;
...
var fcSymbol = (0, _symbol.serif)({ size: 45 }).outerHTML;

var floaters = _$2.default.cls('floater');

_3.default.each(floaters, function (floater, i) {
  ...
  var moveFloater = function moveFloater() {
    ...
    var moveX = _3.default.random(0, _$2.default.window.width) + 'px';
    var moveY = _3.default.random(0, _$2.default.window.height) + 'px';
    (0, _$2.default)(floater, 'margin-left', moveX);
    (0, _$2.default)(floater, 'margin-top', moveY);
  };

  moveFloater();
  var floating = setInterval(moveFloater, _3.default.random(1000, 3000, true));

  _$2.default.onClick(floater)(function () {
    console.log('clicked floater', i);
    (0, _playTone2.default)();
    (0, _$2.default)(floater, 'display', 'none');
...
function dynamicInterval(fn) {
  ...
  var newInterval = function newInterval(execute, time) {
    clearInterval(interval);
    interval = setInterval(execute, time);
  };

  var set = function set(time) {
    for (var _len = arguments.length, setArgs = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      setArgs[_key - 1] = arguments[_key];
    }
    ...
    var timeElapsed = _.round(Date.now() - now);
    var timeLeft = time - timeElapsed;
    var timeLeftInInterval = _.atLeast(timeLeft)(0);
...
var _api = __webpack_require__(613);
...
var _step3 = __webpack_require__(617);

var _step4 = _interopRequireDefault(_step3);

var _step5 = __webpack_require__(618);

var _step6 = _interopRequireDefault(_step5);

var _step7 = __webpack_require__(620);

var _step8 = _interopRequireDefault(_step7);

var _loading = __webpack_require__(621);
...
var parse = function parse(template, id) {
  return parser.parseFromString(template(), 'text/html').childNodes[0];
};
  ...
  triggers.forEach(function (trigger) {
    if (trigger) trigger.addEventListener('click', function () {
      ...
      setTimeout(function () {
        component.className = '';
        setTimeout(function () {
          return (0, _playTone2.default)(1000, 200);
        }, 300);
      }, 300);
    });
  });
...
module.exports = function (scope) {
  return "<div id=\"signupModal-loading\" style=\"overflow-wrap: break-word; width: 35em;font-size: 22px;\">\n  LOADING\n</div>\n";
};
